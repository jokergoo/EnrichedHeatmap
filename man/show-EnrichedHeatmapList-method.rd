...
\details{
Actually it calls \code{\link{draw,EnrichedHeatmapList-method}}, but only with default parameters. If users want to customize the heatmap, they can pass parameters directly to \code{\link{draw,EnrichedHeatmapList-method}}.  

...
\arguments{
  ...
  \item{show_error}{whether show error regions which are +-1 standard error to the mean value. Color of error area is same as the corresponding lines with 75 percent transparency.}

}
\details{
This annotation functions shows mean values (or depends on the value set in \code{value} argument) of columns in the normalized matrix

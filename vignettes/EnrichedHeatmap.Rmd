...
draw(ht_list, split = partition, annotation_legend_list = list(lgd), ht_gap = unit(8, "mm"))
```
...
To make the conversion simple, users can directly use `as.normalizedMatrix()` for the conversion.

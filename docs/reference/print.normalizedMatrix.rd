...
<li>
  ...
  <div class="col-md-9 contents">
    ...
    <h1>Print the Normalized Matrix</h1>
    
    <div class="hidden name"><code>print.normalizedMatrix.rd</code></div>
    </div>

    <div class="ref-description">
    <p>Print the Normalized Matrix</p>
    </div>
